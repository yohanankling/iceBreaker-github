...
//                                   + " | Area : " + dataSnapshot.child("Area").getValue().toString();
                    ...
                    CostumBaseadapter costumBaseadapter = new CostumBaseadapter(PlayZone.this, usersName);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(PlayZone.this, "faild to load users..try again", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setChatChoose() {
        userListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(PlayZone.this, TicTacToe.class);
